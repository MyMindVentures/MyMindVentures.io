        ...
        submenu: [
          {
            ...
            submenu: [
              ...
              },
              {
                ...
                label: '📚 Developer Instructions & Docs',
                icon: BookOpen,
              },
              { id: 'app-build-log', label: 'App Build Log', icon: FileText },
              {
                id: 'git-management',
              ...
              },
              {
                ...
                label: '🚀 State of Art Toolkit',
                icon: Zap,
              },
              {
                id: 'ai-documentation-workflow',
                label: 'AI Documentation Workflow',
                icon: Brain,
              },
              {
                id: 'ai-insights-manager',
                label: '🤖 AI Insights Manager',
                icon: Brain,
              },
              {
                id: 'dynamic-documentation',
                label: 'Dynamic Documentation',
                icon: BookOpen,
              },
              {
                id: 'app-updates-timeline',
                label: 'App Updates Timeline',
                icon: Rocket,
              },
              {
                id: 'brain-nft-connection',
                label: 'Brain NFT Connection',
                icon: Brain,
              },
            ],
          },
            ...
            submenu: [
              {
                ...
                label: 'Complete App Documentation',
                icon: FileText,
              },
            ],
          },
