...
export const UserProfile: React.FC<UserProfileProps> = ({
  ...
  const loadUserProfile = async () => {
    setIsLoading(true);
    try {
      const { data, error } = await db.getUserProfile(
                ...
                {isEditing ? (
                  <div className='space-y-3'>
                    ...
                    <Input
                      ...
                      onChange={value =>
                        setEditForm(prev => ({ ...prev, company: value }))
                      }
                    />
                    <Input
                      label='Location'
                  ...
                  <div className='space-y-3'>
                    ...
                    <div className='flex items-center space-x-3'>
                      ...
                      <span className='text-gray-300'>
                        Joined{' '}
                        {new Date(userData.joined_date).toLocaleDateString()}
                      </span>
                    </div>
                  </div>
                )}
                ...
                {[
                  {
                    ...
                    desc: 'Built revolutionary AI platform',
                    icon: Crown,
                    color: 'from-yellow-400 to-orange-500',
                  },
                  {
                    title: 'ADHD Innovator',
                    desc: 'Unique blueprinting talents',
                    icon: Shield,
                    color: 'from-purple-400 to-pink-500',
                  },
                  {
                    title: 'AI Pioneer',
                    desc: 'Multi-AI orchestration expert',
                    icon: Zap,
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`w-10 h-10 rounded-lg bg-gradient-to-r ${achievement.color} flex items-center justify-center mb-3`}
                      >
