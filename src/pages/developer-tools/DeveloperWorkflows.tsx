...
export const DeveloperWorkflows: React.FC<DeveloperWorkflowsProps> = ({
  onBack,
}) => {
  ...
  const workflows: Workflow[] = [
    {
      ...
      description:
        'Standard workflow for creating and managing blueprint snippets',
    ...
    },
    {
      ...
      description:
        'Process for integrating AI services and testing connections',
      category: 'AI',
  ...
  const filteredWorkflows = workflows.filter(
    workflow => selectedWorkflow === 'all' || workflow.id === selectedWorkflow
  );
    ...
    >
      ...
      <div className='flex items-center space-x-4'>
        ...
        <h1 className='text-2xl font-bold text-white'>
          Developer Workflows & Instructions
        </h1>
      </div>
