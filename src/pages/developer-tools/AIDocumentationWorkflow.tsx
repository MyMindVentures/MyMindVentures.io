...
export const AIDocumentationWorkflow: React.FC<
  AIDocumentationWorkflowProps
> = ({ onBack }) => {
    ...
    <div className='space-y-6'>
      <Card>
        <div className='flex items-center justify-between mb-4'>
          ...
          <div className='flex gap-2'>
            <Button
              onClick={loadRecoveryDocumentation}
              variant='outline'
              size='sm'
            >
        ...
        {recoveryDocs.length === 0 ? (
          <div className='text-center py-8 text-gray-400'>
            ...
            <p>
              No recovery documentation found. Run the AI workflow to generate
              documentation.
            </p>
          </div>
        ) : (
          <div className='space-y-4'>
            {recoveryDocs.map(doc => (
              ...
              >
                ...
                <div className='flex gap-2'>
                  <Button onClick={() => setSelectedDoc(doc)} size='sm'>
      ...
      <Card>
        <div className='flex items-center justify-between mb-4'>
          ...
          <div className='flex gap-2'>
            <Button
              onClick={loadDocumentationPages}
              variant='outline'
              size='sm'
            >
              <RefreshCw className='w-4 h-4' />
        ...
        {documentationPages.length === 0 ? (
          <div className='text-center py-8 text-gray-400'>
            ...
            <p>
              No documentation pages found. Run the AI workflow to generate
              pages.
            </p>
          </div>
        ) : (
        ...
        <div className='flex items-center gap-4 mb-8'>
          ...
          <div>
            ...
            <p className='text-gray-400'>
              OpenAI-powered codebase analysis and documentation generation
            </p>
          </div>
        </div>
        ...
        >
          ...
          {selectedView === 'git' && (
            <Card>
              ...
              <p className='text-gray-400 mb-4'>
                The AI Documentation Workflow integrates seamlessly with Git
                Management. When you run the workflow with "Generate Git commit"
                enabled, it will:
              </p>
              ...
              <div className='mt-4 p-4 bg-gray-800 rounded-lg'>
                ...
                <p className='text-sm text-gray-400'>
                  Use the AI Documentation Workflow before major releases to
                  ensure all documentation is up-to-date and properly committed
                  to Git.
                </p>
              </div>
            </Card>
          ...
          {selectedView === 'history' && (
            <Card>
              ...
              <p className='text-gray-400'>
                View the complete history of AI documentation workflows and
                their results. This helps track documentation evolution and
                identify patterns.
              </p>
                ...
                <div className='prose prose-invert max-w-none'>
                  <div
                    dangerouslySetInnerHTML={{
                      __html: selectedDoc.recovery_guide.replace(/\n/g, '<br>'),
                    }}
                  />
                </div>
              </div>
