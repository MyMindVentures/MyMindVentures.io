...
export const UserFlowPipelines: React.FC<UserFlowPipelinesProps> = ({
  onBack,
}) => {
  ...
  const pipelines: Pipeline[] = [
    {
      ...
      steps: [
        {
          id: '1',
          name: 'Create Blueprint Snippets',
          description: 'Gather development notes and create themed snippets',
          status: 'completed',
          duration: '2h',
        },
        {
        ...
        },
        {
          ...
          description: 'Create structured commits with full summaries',
          status: 'pending',
          dependencies: ['1', '2'],
        },
        {
          ...
          description: 'AI generates complete application blueprint',
          status: 'pending',
          dependencies: ['3'],
        },
        {
          ...
          description: 'Update special pages and user guides',
          status: 'pending',
          dependencies: ['4'],
        },
        {
          id: '6',
          name: 'Publication',
          description: 'Publish version with release notes',
          status: 'pending',
          dependencies: ['5'],
        },
      ],
    },
    {
      ...
      steps: [
        ...
        },
        {
          id: '4',
          name: 'First Project',
          description: 'Create initial blueprint snippet',
          status: 'completed',
          duration: '15m',
        },
      ],
      ...
      steps: [
        {
          ...
          description: 'Gather uncommitted snippets',
          status: 'completed',
          duration: '1m',
        },
        {
          ...
          description: 'Generate commit messages and summaries',
          status: 'error',
          duration: '30s',
        },
        {
          ...
          description: 'Create blueprints and documentation',
          status: 'pending',
          dependencies: ['2'],
        },
        {
        ...
        {pipelines.map((pipeline, index) => (
          ...
          >
            <div className='flex items-center justify-between mb-2'>
              ...
              <div
                className={`flex items-center space-x-1 px-2 py-1 rounded text-xs ${getPipelineStatusColor(pipeline.status)}`}
              >
                    ...
                    <div className='flex-1'>
                      <div className='flex items-center justify-between mb-1'>
                        ...
                        <div className='flex items-center space-x-2'>
                          ...
                          <span
                            className={`text-xs px-2 py-1 rounded capitalize ${getPipelineStatusColor(step.status)}`}
                          >
                            {step.status}
                          </span>
                        </div>
