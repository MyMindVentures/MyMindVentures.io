...
export const AppUserGuides: React.FC<AppUserGuidesProps> = ({ onBack }) => {
  ...
  const guides: GuideItem[] = [
    {
      ...
      description: 'Complete walkthrough for new users to set up and start using MyMindVentures.io',
      type: 'guide',
      category: 'Basics',
      icon: BookOpen,
    ...
    },
    {
      ...
      description: 'Learn how to create, manage, and commit blueprint snippets effectively',
      type: 'tutorial',
    ...
    },
    {
      ...
      description: 'How to connect and use OpenAI, Perplexity, and other AI services',
      type: 'guide',
      category: 'AI & APIs',
      icon: Zap,
    ...
    },
    {
      ...
      description: 'Best practices for efficient development workflows and automation',
      type: 'guide',
      category: 'Development',
      icon: Code,
  ...
  const categories = ['all', 'Basics', 'Development', 'AI & APIs', 'Database', 'Support'];
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {[
          { label: 'Total Guides', value: guides.length.toString(), icon: BookOpen, color: 'text-cyan-400' },
          { label: 'Available', value: guides.filter(g => g.status === 'available').length.toString(), icon: Eye, color: 'text-green-400' },
          { label: 'Categories', value: (categories.length - 1).toString(), icon: Filter, color: 'text-purple-400' },
          { label: 'Coming Soon', value: guides.filter(g => g.status === 'coming-soon').length.toString(), icon: FileText, color: 'text-orange-400' },
        ].map((stat, index) => {
              ...
              <div className="space-y-4">
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    <div className={`flex items-center space-x-1 px-2 py-1 rounded text-xs ${getTypeColor(guide.type)}`}>
      ...
      {filteredGuides.length === 0 && (
        <div className="text-center py-12">
          <div className="text-gray-400 mb-4">No guides match your search criteria</div>
