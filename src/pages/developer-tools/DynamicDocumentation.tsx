...
export const DynamicDocumentation: React.FC<DynamicDocumentationProps> = ({
  onBack,
}) => {
  ...
  const [selectedPage, setSelectedPage] = useState<DocumentationPage | null>(
    null
  );
  const [selectedView, setSelectedView] = useState<
    'pages' | 'recovery' | 'update' | 'history'
  >('pages');
  const [isUpdating, setIsUpdating] = useState(false);
  const [isGenerating, setIsGenerating] = useState(false);
  const [searchTerm, setSearchTerm] = useState('');
  const [selectedPageType, setSelectedPageType] = useState<string>('all');
  const [editingPage, setEditingPage] = useState<DocumentationPage | null>(
    null
  );
  ...
  const filteredPages = documentationPages.filter(page => {
    ...
    const matchesType =
      selectedPageType === 'all' || page.page_type === selectedPageType;
          ...
          <Card key={page.id} className='hover:shadow-lg transition-shadow'>
            <div className='flex items-start justify-between mb-3'>
              ...
              <div className='flex gap-1'>
                ...
                <Button onClick={() => setSelectedPage(page)} size='sm'>
  ...
  const renderUpdateView = () => (
    <div className='space-y-6'>
          ...
          <div className='space-y-4'>
            <div className='p-4 bg-gradient-to-r from-purple-900 to-blue-900 rounded-lg'>
              ...
              <p className='text-sm mb-3'>
                Scans entire codebase and updates ALL documentation pages with
                latest analysis
              </p>
              <Button
      ...
      <Card>
        ...
        <p className='text-gray-400 mb-4'>
          Every documentation update is automatically committed to Git with
          professional commit messages generated by OpenAI.
        </p>
        ...
        <div className='flex items-center gap-4 mb-8'>
          ...
          <div>
            ...
            <p className='text-gray-400'>
              Real-time documentation rendering from Supabase with AI-powered
              updates
            </p>
          </div>
        </div>
        ...
        >
            ...
            <Card>
              ...
              {recoveryDocs.length === 0 ? (
                <div className='text-center py-8 text-gray-400'>
                  ...
                  <p>
                    No recovery documentation found. Run the AI workflow to
          ...
          {selectedView === 'history' && (
            <Card>
              ...
              <p className='text-gray-400'>
                Track all documentation updates, AI generations, and manual
                edits over time. This helps maintain a complete audit trail of
              ...
              <div className='flex items-center justify-between p-4 border-b border-gray-700'>
                <div>
                  ...
                  <p className='text-sm text-gray-400'>
                    {selectedPage.page_type} • v{selectedPage.version}
                  </p>
                </div>
                <Button
                ...
                <div className='prose prose-invert max-w-none'>
                  <div
                    dangerouslySetInnerHTML={{
                      __html: selectedPage.content.replace(/\n/g, '<br>'),
                    }}
                  />
                </div>
              </div>
