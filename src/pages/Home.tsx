    ...
    <div className="p-6 space-y-8">
      ...
      >
        ...
        <p className="text-xl text-gray-400 max-w-3xl mx-auto">
          A futuristic platform for managing your development ventures, 
          building applications, and accelerating innovation through AI-powered tools.
        </p>
      </motion.div>
        ...
        {[
          {
            ...
            description: 'Connect with OpenAI and Perplexity for intelligent assistance',
            icon: Brain,
            color: 'from-cyan-400 to-blue-500',
          },
          {
            title: 'Data Management',
            description: 'Seamless Supabase integration for all your data needs',
            icon: Database,
            color: 'from-green-400 to-emerald-500',
          },
          {
            title: 'Build Tools',
            description: 'Comprehensive tools for managing your development workflow',
            icon: Zap,
            color: 'from-purple-400 to-pink-500',
          },
          {
            title: 'Scalable Architecture',
            description: 'Built for growth with edge functions and modern patterns',
            icon: Rocket,
      ...
      <Card title="Quick Actions" gradient>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <button className="p-4 bg-gray-700/30 rounded-lg border border-gray-600/30 hover:border-cyan-500/50 hover:bg-gray-700/50 transition-all duration-200 text-left group">
            ...
            <p className="text-gray-400 text-sm">Initialize a new development venture</p>
          </button>
          ...
          <button className="p-4 bg-gray-700/30 rounded-lg border border-gray-600/30 hover:border-purple-500/50 hover:bg-gray-700/50 transition-all duration-200 text-left group">
            ...
            <p className="text-gray-400 text-sm">Get AI-powered insights and suggestions</p>
          </button>
          ...
          <button className="p-4 bg-gray-700/30 rounded-lg border border-gray-600/30 hover:border-green-500/50 hover:bg-gray-700/50 transition-all duration-200 text-left group">
            ...
            <p className="text-gray-400 text-sm">Monitor your database connections and health</p>
          </button>
        </div>
      </Card>
    </div>
